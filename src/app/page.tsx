      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="max-w-3xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-bbw-green-500 flex items-center justify-center text-white font-bold text-lg">B</div>
            <div>
              <h1 className="text-sm font-bold text-gray-900">Merkblatt NRL IKT</h1>
              <p className="text-xs text-gray-500">BBW Winterthur</p>
            </div>
          </div>
          <a href="/251126_Nutzungsrichtlinie_IKT_BBW.pdf" target="_blank" rel="noopener noreferrer" className="text-xs bg-bbw-green-50 text-bbw-green-700 px-3 py-1.5 rounded-lg hover:bg-bbw-green-100 transition-colors font-medium">Gesamt-NRL (PDF)</a>
        </div>
      </header>
