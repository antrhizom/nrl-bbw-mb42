...
export default function Datensicherheit1Section() {
  ...
  const flipCards = [
    { title: "In der Regel BBW-Speicher", description: "Schulinterne Daten in der Regel auf BBW-Speichern (OneDrive, Teams, SharePoint, Schulserver, Nextcloud, OpenOlat). Ausnahmen je nach Berufsgruppe/Abteilung." },
  ...
  return (
    <SectionCard chapterLabel="Kapitel 2" title="Datensicherheit – Grundlagen">
      <p className="text-gray-700 leading-relaxed">
        ...
        Schützen Sie Ihre Zugänge mit <InfoTerm>MFA</InfoTerm>. Die BBW verfügt über eine eigene <InfoTerm>Firewall</InfoTerm>.
      </p>
